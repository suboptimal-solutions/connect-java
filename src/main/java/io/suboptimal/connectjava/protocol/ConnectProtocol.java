 ...
 * }</pre>
 *
 * @see ConnectProtocolConfig
 */
public class ConnectProtocol {
    private final ConnectChannelConfigurer http1Configurer;
    private final ConnectChannelConfigurer http2Configurer;

    /**
     * Creates a new {@link ConnectProtocol} from the given configuration.
     *
     * <p>Use {@link ConnectProtocolConfig#builder(java.util.Map, ConnectCallHandlerFactory,
     * ConnectProtocolParameters, io.suboptimal.connectjava.codec.ConnectCodecRegistry)}
     ...
     * @see ConnectProtocolConfig
     */
    public ConnectProtocol(ConnectProtocolConfig config) {
        this.http1Configurer = new ConnectChannelConfigurer(ConnectTransport.HTTP_1_1, config);
        this.http2Configurer = new ConnectChannelConfigurer(ConnectTransport.HTTP_2, config);
    }

    /**
     * Returns the configurer for HTTP/1.1 channels.
     *
     * <p>The channel passed to {@link ConnectChannelConfigurer#configure(io.netty.channel.Channel)}
     ...
     */
    public ConnectChannelConfigurer http1() {
     ...
     */
    public ConnectChannelConfigurer http2() {
