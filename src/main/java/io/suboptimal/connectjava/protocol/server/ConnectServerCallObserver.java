 ...
 */
public interface ConnectServerCallObserver {
    ConnectServerCallObserver NOOP = new NoOpConnectCallObserver();
     ...
     * before {@link ConnectServerInterceptor#interceptCall} returned.
     */
     ...
     */
    record NoOpConnectCallObserver() implements ConnectServerCallObserver {}
}
