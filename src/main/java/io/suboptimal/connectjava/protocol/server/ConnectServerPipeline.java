 ...
 */
public final class ConnectServerPipeline {
    /** Name of the {@link CorsHandler} optionally installed by {@link ConnectServerChannelConfigurer}. */
    public static final String CORS_HANDLER = "connectCors";

    /** Name of the {@link RoutingServerHandler} installed by {@link ConnectServerChannelConfigurer}. */
    public static final String ROUTING_HANDLER = "connectRouting";

    /**
     * Name of the standard Netty {@link HttpObjectAggregator} that {@link RoutingServerHandler}
    ...
    /** Name of the {@link StreamingServerHandler} installed on the streaming path. */
    public static final String STREAMING_HANDLER = "connectStreaming";

    private ConnectServerPipeline() {}
}
