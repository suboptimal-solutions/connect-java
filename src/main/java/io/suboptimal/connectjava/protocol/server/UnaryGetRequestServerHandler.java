 ...
 * installs {@link UnaryResponseProcessingServerHandler} to own the outbound response
 * state machine.
 */
class UnaryGetRequestServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest request) {
        ...
        ctx.pipeline().addAfter(ConnectServerPipeline.UNARY_GET_REQUEST_HANDLER, ConnectServerPipeline.UNARY_RESPONSE_HANDLER,
