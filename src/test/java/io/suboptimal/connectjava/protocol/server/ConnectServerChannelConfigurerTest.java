...
class ConnectServerChannelConfigurerTest {
    ...
    class Http1 {
        ...
        void installsExpectedPipeline() {
            ...
            assertThat(channel.pipeline().get(ConnectServerPipeline.CORS_HANDLER))
            ...
            assertThat(channel.pipeline().names())
                .containsSequence(
                    ConnectServerPipeline.CORS_HANDLER,
    ...
    void configureChannel(ConnectTransport transport) {
        new ConnectServerChannelConfigurer(transport,
            ConnectServerProtocolConfig.builder(Map.of(), TerminalHandler::new, PARAMETERS, ConnectCodecRegistry.builder().build()).build())
            .configure(channel);
    }
