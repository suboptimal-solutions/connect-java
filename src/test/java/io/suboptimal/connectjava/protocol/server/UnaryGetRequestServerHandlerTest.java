...
class UnaryGetRequestServerHandlerTest {
    ...
    void setUpHandler(String methodName, int maxRequestBytes) {
        setUpHandler(methodName, maxRequestBytes, ConnectServerInterceptorPipeline.EMPTY);
    }
        ...
        ConnectServerInterceptorPipeline interceptorPipeline)
    {
        ...
        channel.pipeline().addLast(ConnectServerPipeline.UNARY_GET_REQUEST_HANDLER,
