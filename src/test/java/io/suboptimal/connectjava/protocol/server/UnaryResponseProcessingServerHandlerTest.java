...
class UnaryResponseProcessingServerHandlerTest {
    ...
    void setUpHandler(ConnectCodec codec, ConnectCompression compression, boolean varyAcceptEncoding) {
        setUpHandler(codec, compression, varyAcceptEncoding, ConnectServerCallObserver.NOOP);
    }

    void setUpHandler(ConnectCodec codec, ConnectCompression compression, boolean varyAcceptEncoding,
        ConnectServerCallObserver observer)
    {
        channel.pipeline().addLast(ConnectServerPipeline.UNARY_RESPONSE_HANDLER,
            new UnaryResponseProcessingServerHandler(
                createExchange(), codec, compression, varyAcceptEncoding,
                observer, ConnectStringBuilderJsonSerializer.INSTANCE));
    }

    void setUpHandler(ConnectCodec codec, ConnectCompression compression, boolean varyAcceptEncoding,
        List<ConnectServerCallObserver> observers)
    {
    ...
    private static ConnectServerCallObserver composite(List<ConnectServerCallObserver> observers) {
        return new ConnectServerInterceptorPipeline(observers.stream()
    ...
    void interceptorsMutateUnaryHeadersAndTrailersInExpectedOrder() {
        ...
        ConnectServerCallObserver first = new ConnectServerCallObserver() {
            @Override
        ...
        ConnectServerCallObserver second = new ConnectServerCallObserver() {
            @Override
            public void onResponseHeaders(ConnectResponseHeadersBuilder headers) {
